# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [mlops_demo_aws/databricks-resources/README.md](../../databricks-resources/README.md)
