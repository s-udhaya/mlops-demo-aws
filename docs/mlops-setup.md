...
[ML Config](../mlops_demo_aws/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore mlops_demo_aws/databricks-resources/README.md
...
* [databricks-dev.yaml](../mlops_demo_aws/training/profiles/databricks-dev.yaml): specify recipe configs to use in dev workspace
* [databricks-staging.yaml](../mlops_demo_aws/training/profiles/databricks-staging.yaml): specify recipe configs to use in recurring model training and batch inference
  jobs that run in the staging workspace
* [databricks-prod.yaml](../mlops_demo_aws/training/profiles/databricks-prod.yaml) specify recipe configs to use in recurring model training and batch inference
  jobs that run in the prod workspace
* [databricks-test.yaml](../mlops_demo_aws/training/profiles/databricks-test.yaml): specify recipe configs to use in integration tests(CI)
...
Follow the instructions in [mlops-demo-aws/databricks-resources/README.md](../mlops_demo_aws/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../mlops_demo_aws/databricks-resources/README.md)  to propose, test, and deploy
