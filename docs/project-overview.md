...
```
mlops-demo-aws         <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_demo_aws       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
